...
해당 레파지토리는 [뉴로 심볼릭 유도 규칙을 활용한 지식 추론 및 지식 완성 방법](http://oasis.dcollection.net/public_resource/pdf/200000491588_20211109213038.pdf)를 구현한 것입니다. 해당 코드에 대한 documentation이나 직관적인 파악은 Neuro-Symbolic/NTP/NTP_docu_1013.pdf 나 Neuro-Symbolic/NTP/학위 논문 공개발표_신원철.pdf를 참조 하십시오.
